// A comprehensive list of Material Design colors
const materialColors = {
    ...
    "brown": { "50": "#efebe9", "100": "#d7ccc8", "200": "#bcaaa4", "300": "#a1887f", "400": "#8d6e63", "500": "#795548", "600": "#6d4c41", "700": "#5d4037", "800": "#4e342e", "900": "#3e2727" },
...
function generatePalette() {
    ...
    const selectedShade = shadeSelector.value;

    const closestHueName = findClosestHue(selectedColor, selectedShade);
    const palette = materialColors[closestHueName];

    displayPalette(palette);
}

function findClosestHue(hexColor, shade) {
    let closestHue = 'red';
    let smallestDifference = Infinity;

    for (const hue in materialColors) {
        if (materialColors[hue][shade]) {
            const difference = tinycolor.readability(hexColor, materialColors[hue][shade]);
